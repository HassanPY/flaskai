...
ROUTE = [
    {"lat": 25.276987, "long": 55.296249, "name": "Dubai", "is_stop_location": True},
    {"lat": 24.466667, "long": 54.366669, "name": "Abu Dhabi", "is_stop_location": True},
    {"lat": 25.322327, "long": 55.513641, "name": "الشارقة", "is_stop_location": True},
    {"lat": 25.800694, "long": 55.976200, "name": "RAK", "is_stop_location": True},
    {"lat": 25.41111, "long": 55.43504, "name": "Ajman", "is_stop_location": True},
    {"lat": 24.207500, "long": 55.744720, "name": "Al AIN", "is_stop_location": True},
]
...
def create_stop_locations_details():
    ...
    for location in ROUTE:
        ...
        #print(feature)
        stop_locations.append(feature)
    sensor_locations =  FeatureCollection(stop_locations)
    print (json.dumps(sensor_locations, indent=4))
